var datasets = {
    '(*clear*)': '',
    'Philippines coastal risk reduction': 'gs://ecoshard-root/wwf_meeting_viewer/cog_coastal_risk_reduction_total_value_sum_ph_baseline_md5_b64198.tif',
    'Philippines sediment export': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_sed_export_wwf_ph_baseline_md5_594028.tif',
    'Philippines soil erosion (USLE)': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_usle_wwf_ph_baseline_md5_a5a698.tif',
    //'Philippines sediment deposition': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_sed_deposition_wwf_ph_baseline_md5_b8de70.tif',
    'Philippines sediment retention': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_sed_retention_wwf_ph_baseline_md5_b51d33.tif',
    ...
    'Caraga sediment export': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_sed_export_wwf_ph-caragas_baseline_md5_ca1be1.tif',
    'Caraga soil erosion (USLE)': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_usle_wwf_ph-caragas_baseline_md5_d606a6.tif',
    //'Caraga sediment deposition': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_sed_deposition_wwf_ph-caragas_baseline_md5_fa5cd5.tif',
    'Caraga sediment retention': 'gs://ecoshard-root/wwf_meeting_viewer/cog_stitched_sed_retention_wwf_ph-caragas_baseline_md5_52301f.tif',
    'Global sediment export': 'gs://ecoshard-root/wwf_meeting_viewer/cog_global_sed_export_esamod2_compressed_md5_fa10fd3d1942d0c3ce78b5aa544b150f.tif',
    'Global soil erosion (USLE)': 'gs://ecoshard-root/wwf_meeting_viewer/cog_global_usle_marine_mod_ESA_2020_compressed_md5_99e715.tif',
    ...
    'Potential improvement in sediment retention through restoration': 'gs://ecoshard-root/wwf_meeting_viewer/cog_sed_retention_potential_change_to_PNV_md5_6a550e.tif',
    'Potential improvement in soil loss through restoration': 'gs://ecoshard-root/wwf_meeting_viewer/cog_usle_potential_change_to_PNV_md5_0c4e97.tif',
...
Map.setCenter(122.695894, 11.318115, 6);
